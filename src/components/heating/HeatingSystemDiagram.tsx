    ...
    <div className="glass-card p-4 sm:p-6">
      ...
      <div className="relative w-full h-80 sm:h-96">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 w-16 sm:w-20">
          <div className="relative rounded-2xl border-2 border-primary/30 bg-linear-to-t from-cooling/20 via-primary/10 to-heating/20 h-36 sm:h-44 overflow-hidden">
